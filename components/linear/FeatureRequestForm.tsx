...
export function FeatureRequestForm() {
    ...
    async function onSubmit(e: React.FormEvent) {
        ...
        try {
            ...
            if (!res.ok) {
                setError(json?.error || 'Failed to submit feature request.');
                return;
            }

            if (!json?.issue?.identifier) {
                setError('Feature request submitted, but response was unexpected.');
                return;
            }
                    ...
                    <div className="py-8 md:py-10">
                        ...
                        >
                            ...
                            <p className="text-sm md:text-base text-gray-600 mt-2 max-w-md">
                                Thanks — we appreciate your idea!
                            </p>
                        ...
                        <form onSubmit={onSubmit} className="mt-6 space-y-5">
                            ...
                            <div className="w-full">
                                ...
                                <textarea
                                    ...
                                    placeholder="Describe your idea, why it's useful, and how you imagine it working..."
                                    value={description}
