...
import { listLabelIssues, linearPriorityLabel } from '@/lib/linear';
...
export default async function IssuesPage() {
  ...
  try {
    issues = await listLabelIssues({ first: 50 });
  } catch (err) {
    console.error('Failed to load Linear issues for /issues', err);
          ...
          <div className="container-content max-w-4xl">
            <div className="text-center mb-10">
              ...
              <p className="text-lg text-gray-600 mt-3">
                Live view of issues labeled <span className="font-semibold">Schedulr</span>.
              </p>
            </div>
            ...
            {loadError ? (
              ...
              <Card hover={false} className="border border-gray-100">
                <div className="text-sm text-gray-700">No issues found.</div>
              </Card>
            ) : (
