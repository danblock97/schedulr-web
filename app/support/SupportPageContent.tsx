...
interface SupportPageContentProps {
    initialIssues: PublicLinearIssue[] | null;
    ...
    return (
        <div className="min-h-screen flex flex-col overflow-x-hidden">
            ...
            <main className="flex-1">
                <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-gradient-to-b from-white via-indigo-50/30 to-white pt-40 pb-20">
                    <AnimatedGradient />
                    <OrbitalBackground />
                    ...
                    <div className="container-content max-w-4xl relative z-10 w-full px-4">
                        <motion.div
